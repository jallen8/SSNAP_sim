...
{   
   ...
   double COMEnergyOut, COMEnergyRec, FinalZOut, OutMass;
...
//Fill in Tree for the reaction
	...
	period = 2*Pi*OutMass*931.502*0.00000000000016/charge/1.6e-19/6/300000000/300000000*1000000000; //in ns
...
//	cout << FinalZOut <<endl;
	...
	heliosTheta = 180/Pi*acos(FinalZOut*sqrt(931.502*OutMass/(2*LabEnergyOut))/(300000000*period/1000000000*100));
	heliosZ=sqrt(2*LabEnergyOut/OutMass/931.502)*cos(LabThetaOut*3.14159/180)*300000000*period*0.000000001*100;
